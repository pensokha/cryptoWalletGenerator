...
async function generateAndCheckBalances() {
    ...
    console.log(`\nStarting balance check for ${seedPhrases.length} wallets using Web3...`);
    console.log("-----------------------------------------------------------------------\n");
    ...
    for (let i = 0; i < seedPhrases.length; i++) {
        ...
        try {
            ...
            // 2. Fetch Balance using Web3 Provider
